...
export class MdTooltip implements OnDestroy {
  ...
  get _positionDeprecated(): TooltipPosition {
    return this._position;
  }

  set _positionDeprecated(value: TooltipPosition) {
    this._position = value;
  }
  ...
  /** @deprecated */
  @Input('md-tooltip')
  get _deprecatedMessage(): string {
    return this.message;
  }

  set _deprecatedMessage(v: string) {
    this.message = v;
  }
  ...
  _setTransformOrigin(value: TooltipPosition) {
    ...
    switch (value) {
      ...
      case 'below':
        ...
        break;
      default:
        throwMdTooltipInvalidPositionError(value);
    }
  }
